...
namespace System.Numerics.Tensors
{
    public static partial class TensorPrimitives
    {
        ...
        /// <param name="x">The tensor, represented as a span.</param>
        /// <returns><see langword="true"/> if all of the values in <paramref name="x"/> are powers of two; otherwise, <see langword="false"/>.</returns>
        ...
        /// <param name="x">The tensor, represented as a span.</param>
        /// <returns><see langword="true"/> if any of the values in <paramref name="x"/> are powers of two; otherwise, <see langword="false"/>.</returns>
