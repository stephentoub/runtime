...
namespace System.Numerics.Tensors
{
    public static partial class TensorPrimitives
    {
        ...
        /// <param name="x">The tensor, represented as a span.</param>
        /// <returns><see langword="true"/> if all of the values in <paramref name="x"/> are odd integral numbers; otherwise, <see langword="false"/>.</returns>
        ...
        /// <param name="x">The tensor, represented as a span.</param>
        /// <returns><see langword="true"/> if any of the values in <paramref name="x"/> is an odd integral number; otherwise, <see langword="false"/>.</returns>
            ...
            where T : INumberBase<T>
        {
            ...
            {
#if NET10_0_OR_GREATER
                return Vector128.IsOddInteger(x);
#else
                return Vector128.Equals(x & Vector128<T>.One, Vector128<T>.One);
#endif
            }
            ...
            {
#if NET10_0_OR_GREATER
                return Vector256.IsOddInteger(x);
#else
                return Vector256.Equals(x & Vector256<T>.One, Vector256<T>.One);
#endif
            }
            ...
            {
#if NET10_0_OR_GREATER
                return Vector512.IsOddInteger(x);
#else
                return Vector512.Equals(x & Vector512<T>.One, Vector512<T>.One);
#endif
            }
        }
    }
