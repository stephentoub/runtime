...
namespace System.Numerics.Tensors
{
    public static partial class TensorPrimitives
    {
            ...
            where T : IRootFunctions<T>
        {
            ...
            T mean = Sum(x) / T.CreateChecked(x.Length);
            SquaredDifferenceOperator<T> sqDiffOp = new(mean);
            T sumSqDiff = Aggregate<T, SquaredDifferenceOperator<T>, AddOperator<T>>(x, ref sqDiffOp);
            T variance = sumSqDiff / T.CreateChecked(x.Length);
