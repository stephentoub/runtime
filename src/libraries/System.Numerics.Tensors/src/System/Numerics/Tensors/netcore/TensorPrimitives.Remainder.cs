...
namespace System.Numerics.Tensors
{
    public static partial class TensorPrimitives
    {
            ...
            where T : IModulusOperators<T, T, T>
        {
            ...
            public static Vector128<T> Invoke(Vector128<T> x, Vector128<T> y) => x - ((x / y) * y);
            public static Vector256<T> Invoke(Vector256<T> x, Vector256<T> y) => x - ((x / y) * y);
            public static Vector512<T> Invoke(Vector512<T> x, Vector512<T> y) => x - ((x / y) * y);
        }
    }
}
