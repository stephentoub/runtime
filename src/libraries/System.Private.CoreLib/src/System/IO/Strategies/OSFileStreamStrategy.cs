...
namespace System.IO.Strategies
{
    ...
    internal abstract class OSFileStreamStrategy : FileStreamStrategy
    {
        ...
        internal sealed override void Lock(long position, long length) => FileStreamHelpers.Lock(_fileHandle, _path, CanWrite, position, length);
        ...
        public sealed override int Read(Span<byte> buffer)
        {
            ...
            int r = RandomAccess.ReadAtOffset(_fileHandle, buffer, CanSeek ? _filePosition : -1, _path);
        ...
        public sealed override void Write(ReadOnlySpan<byte> buffer)
        {
            ...
            int r = RandomAccess.WriteAtOffset(_fileHandle, buffer, CanSeek ? _filePosition : -1, _path);
