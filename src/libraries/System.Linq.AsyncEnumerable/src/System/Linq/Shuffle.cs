...
namespace System.Linq
{
    public static partial class AsyncEnumerable
    {
        ...
        private sealed partial class ShuffleIterator<TSource>(IAsyncEnumerable<TSource> source) : Iterator<TSource>
        {
            ...
            public override ValueTask<bool> AnyAsync(CancellationToken cancellationToken) =>
                _source.AnyAsync(cancellationToken);

            public override ValueTask<bool> ContainsAsync(TSource value, CancellationToken cancellationToken) =>
                _source.ContainsAsync(value, comparer: null, cancellationToken);
